...
public class ContaDAO {
    ...
    public Set<Conta> listar() {
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                contas.add(new Conta(numero, saldo, cliente, estaAtivo));
            }
            resultSet.close();
            ps.close();
            conn.close();
    ...
    public Conta listarPorNumero(Integer numero) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                conta = new Conta(numeroRecuperado, saldo, cliente, estaAtivo);
            }
            resultSet.close();
            ps.close();
            conn.close();
    ...
    public void exclusaoLogica(Integer numeroDaConta) {
        PreparedStatement ps;
